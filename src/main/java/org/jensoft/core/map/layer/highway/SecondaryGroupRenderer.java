...
public class SecondaryGroupRenderer implements HighwayGroupRenderer {

    public SecondaryGroupRenderer() {
    ...
    public boolean paintHighwayGroup(Graphics2D g2d, HighwayGroup highwayGroup) {
        ...
        //
        // BasicStroke bs1 = new
        // BasicStroke(15f,BasicStroke.CAP_ROUND,BasicStroke.JOIN_ROUND);
