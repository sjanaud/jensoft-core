 ...
 */
public class MessageScrollbarUI extends MetalScrollBarUI {
     ...
     *            the color to set
     */
    public MessageScrollbarUI(Color scrollbarThemeColor) {
        super();
    ...
    protected JButton createDecreaseButton(int orientation) {
        decreaseButton = new MessageScrollButton(orientation, scrollBarWidth,
    ...
    protected JButton createIncreaseButton(int orientation) {
        increaseButton = new MessageScrollButton(orientation, scrollBarWidth,
                                                 isFreeStanding, scrollbarThemeColor);
