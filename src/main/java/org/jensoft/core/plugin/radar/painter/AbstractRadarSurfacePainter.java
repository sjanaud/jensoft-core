...
public abstract class AbstractRadarSurfacePainter implements
    ...
    /* (non-Javadoc)
     * @see org.jensoft.core.plugin.radar.painter.RadarSurfacePainter#paintRadarSurface(java.awt.Graphics2D, org.jensoft.core.plugin.radar.Radar, org.jensoft.core.plugin.radar.RadarSurface)
     */
    @Override
