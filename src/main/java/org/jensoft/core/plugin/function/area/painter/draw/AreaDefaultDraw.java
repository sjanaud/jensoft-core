...
public class AreaDefaultDraw extends AbstractAreaDraw {
    ...
    /* (non-Javadoc)
     * @see org.jensoft.core.plugin.function.area.painter.draw.AbstractAreaDraw#paintAreaDraw(java.awt.Graphics2D, org.jensoft.core.plugin.function.area.AreaFunction)
     */
    @Override
