...
public class DemoScrollbarUI extends MetalScrollBarUI {
	...
	protected JButton createDecreaseButton(int orientation) {
		decreaseButton = new DemoScrollButton(orientation, scrollBarWidth, isFreeStanding);
		return decreaseButton;
	}

	@Override
	protected JButton createIncreaseButton(int orientation) {
		increaseButton = new DemoScrollButton(orientation, scrollBarWidth, isFreeStanding);
