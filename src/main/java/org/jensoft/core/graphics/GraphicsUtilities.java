...
public class GraphicsUtilities {
    ...
    /**
     * <p>
     * Returns a new <code>BufferedImage</code> using the same color model as the image passed as a parameter. The
     * returned image is only compatible with the image passed as a parameter. This does not mean the returned image is
    ...
    /**
     * <p>
     * Returns a new compatible image of the specified width and height, and the same transparency setting as the image
    ...
    /**
     * <p>
     * Returns a new compatible image from a URL. The image is loaded from the specified location and then turned, if
     * necessary into a compatible image.
     * </p>
     * 
     * @see #createCompatibleImage(java.awt.image.BufferedImage)
     * @see #createCompatibleImage(java.awt.image.BufferedImage, int, int)
    ...
    /**
     * <p>
     * Return a new compatible image that contains a copy of the specified image. This method ensures an image is
     * compatible with the hardware, and therefore optimized for fast blitting operations.
     * </p>
     * 
     * @see #createCompatibleImage(java.awt.image.BufferedImage)
     * @see #createCompatibleImage(java.awt.image.BufferedImage, int, int)
    ...
    /**
     * <p>
     * Returns a thumbnail of a source image. <code>newSize</code> defines the length of the longest dimension of the
     * thumbnail. The other dimension is then computed according to the dimensions ratio of the original picture.
     * </p>
     * <p>
     * This method favors speed over quality. When the new size is less than half the longest dimension of the source
     * image, {@link #createThumbnail(BufferedImage, int)} or {@link #createThumbnail(BufferedImage, int, int)} should
     * be used instead to ensure the quality of the result without sacrificing too much performance.
     * </p>
     * 
     ...
     *         thumbnail of <code>image</code>
     * @throws IllegalArgumentException
     *             if <code>newWidth</code> is larger than the width of <code>image</code> or if code>newHeight</code>
     *             is larger than
     ...
     * {@link #createThumbnailFast(java.awt.image.BufferedImage, int)} when the new size is less than half the longest
     * dimension of the source image, yet the rendering speed is almost similar.
     * </p>
     * 
     * @see #createThumbnailFast(java.awt.image.BufferedImage, int, int)
     * @see #createThumbnailFast(java.awt.image.BufferedImage, int)
     ...
     *             if <code>newWidth</code> is larger than the width of <code>image</code> or if code>newHeight</code>
     *             is larger than
     *             the height of <code>image or if one the dimensions is not &gt; 0</code>
     */
