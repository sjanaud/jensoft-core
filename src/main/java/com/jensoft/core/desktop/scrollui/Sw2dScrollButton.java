...
class Sw2dScrollButton extends MetalScrollButton {
    ...
    static {
        BUTTON_WEST = new ImageIcon(
                                    Sw2dScrollbarUI.class
                                            .getResource("scrollbar-button-west.png"));
        BUTTON_EAST = new ImageIcon(
                                    Sw2dScrollbarUI.class
                                            .getResource("scrollbar-button-east.png"));
        BUTTON_NORTH = new ImageIcon(
                                     Sw2dScrollbarUI.class
                                             .getResource("scrollbar-button-north.png"));
        BUTTON_SOUTH = new ImageIcon(
                                     Sw2dScrollbarUI.class
                                             .getResource("scrollbar-button-south.png"));
    }
