...
public class TestTileGis {
    ...
    public TestTileGis() {
        try {
            ...
            TileGis tileGis = new TileGis();
            // Tile t14 = t.getTile(4544, 6973, 14);
            // tileGis.insertTile(t14);
            long t1 = System.currentTimeMillis();
            tileGis.selectTileHighways(4544, 6973, 14);
            tileGis.selectTileHighways(4544, 6973, 14);
            tileGis.selectTileHighways(4544, 6973, 14);
            tileGis.selectTileHighways(4544, 6973, 14);
            tileGis.selectTileHighways(4544, 6973, 14);
    ...
    public static void main(String[] args) {
        TestTileGis gis = new TestTileGis();
    }
