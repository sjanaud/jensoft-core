...
public class HighwayPath {
    ...
    /**
     * Array where the index is the index of the original path segment and the
     * value is the index of the first of the flattened segments in {@link #segments} that corresponds to that original
     * path segment.
     */
     ...
     * @return the angle in radians, in the range [-{@link Math#PI}, {@link Math#PI}].
     */
    ...
    /**
     * Returns the index of the path segment that bounds the specified length
     * along the path.
     * 
     * @param length
     *            The length along the path
    ...
    /**
     * A single path segment in the flattened version of the path. This is a
     * local helper class. PathSegment-objects are stored in the {@link HighwayPath#segments} - list. This is used as an
     * immutable
     * value-object.
     */
