...
public class DefaultMarker extends GlyphMetricMarkerPainter {
     ...
     */
    public void setMarkerStrok(Stroke markerStrok) {
        this.markerStrok = markerStrok;
    }
