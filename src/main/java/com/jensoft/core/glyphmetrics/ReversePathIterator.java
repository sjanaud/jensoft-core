...
public class ReversePathIterator implements PathIterator {
	 ...
	 * 
	 * @param shape
	 *            shape for which a reverse transformed flattened path iterator
	 *            is needed
	 * @param flatness
	 *            flatness epsilon
	...
	/**
	 * Returns the winding rule for determining the interior of the path. This
	 * just returns the winding rule of the original path, which may or may not
	 * be what is wanted.
	 * 
	 ...
	 * 
	 * @return {@code true} if all the segments have been read; {@code false}
	 *         otherwise.
	 */
	@Override
