 ...
 */
package com.jensoft.core.sharedicon.common;

public class Common {

    // public static String LOCK = "check-box.png";
    ...
    public static String BOX_CLEAR = "clearcell.png";

    public static String TAG_LABEL = "tag_label.png";
    public static String PEAK = "peak.png";
    public static String MESSAGE = "message_16.png";

    public static String MAXIMIZE_SQUARE = "maximize_square.png";
    public static String MINIMIZE_SQUARE = "minimize_square.png";
    public static String CLOSE_SQUARE = "close_square.png";

    public static String MAIL_16 = "mail-16.png";
    public static String MAIL_24 = "mail-24.png";
    public static String MAIL_32 = "mail-32.png";
    public static String MAIL_48 = "mail-48.png";

    public static String MAIL_REPLY_24 = "mail-reply-24.png";
