...
/**
 * <code>Window2D</code> takes the responsibility to make user projection for hosted plug-ins.
 * <p>
 * The window projection nature are {@link Linear},{@link LogX}, {@link LogY}, {@link Log}, {@link Map} <br>
 * </p>
 * <ul>
 * <li>a window2D has to be registered in a {@link #view2D} with the {@link View2D#registerWindow2D(Window2D)}
 * <li>a window2D should be register plug-ins with {@link #registerPlugin(AbstractPlugin)} method</li>
 * <li>a plug-in developer can be use window projection method {@link #userToPixel(Point2D)} or
 * {@link #pixelToUser(Point2D)} to create plug-ins for himself</li>
 * </ul>
 * 
...
public abstract class Window2D implements PluginListener {
    ...
    public static class Linear extends Window2D implements Serializable {
        ...
        /**
         * bound this {@link Linear} window with the specified double parameters.<br>
         * <p>
         * set the all given parameters as window range. If {@link #initial} is true, initials variables for range are
         * referenced as the window origin bound.
         * </p>
         * 
         * @param minx
         * @param maxx
         ...
         *             if minx is greater than maxx or if miny is greater than maxy
         */
        ...
        /**
         * this method set the initial.
         * on initial, when the {@link #bound(double, double, double, double)} method is call,
         * min and max are copy in initial variables to have a origin range of the initialized window
         * 
         * @param initial
         *            the initial to set
         */
        ...
        public Point2D getUserCenter() {
            return new Point2D.Double(minX + (maxX - minX) / 2, minY
                    + (maxY - minY) / 2);
        }
    ...
    /**
     * The <code>LogX</code> class defines a composite logarithmic linear window with logarithmic x and linear y
     * projection.
     */
    public static class LogX extends Linear implements Serializable {

        /**
         * Constructs a new window2d with logarithmic on x dimension and linear on y dimension
         * with specified user metrics parameters.
         * 
         * @param minx
    ...
    /**
     * The <code>LogY</code> class defines a composite logarithmic linear window with logarithmic y and linear x
     * projection.
     */
    public static class LogY extends Linear implements Serializable {

        /**
         * Constructs a new window2d with logarithmic on y dimension and linear on x dimension
         * with specified user metrics parameters.
         * 
         * @param minx
         *            the window minimum x to set
    ...
    /**
     * The <code>Log</code> class defines a logarithmic projection window on x and y dimension
     */
    public static class Log extends Linear implements Serializable {

        /**
         * Constructs a new window2d with logarithmic on x and y dimension
         * with specified user metrics parameters.
         * 
         * @param minx
         *            the window minimum x to set
    ...
    public static abstract class Time extends Linear implements Serializable {
        ...
        /**
         * get the time duration in millisecond of this time window between min date and max date
         * 
        ...
        /**
         * get the time duration in minutes of this time window between min date and max date
         * 
        ...
        /**
         * get the time duration in hours of this time window between min date and max date
         * 
        ...
        /**
         * get the time duration in days of this time window between min date and max date
         * 
        ...
        /**
         * get the time duration in weeks of this time window between min date and max date
         * 
        ...
        /**
         * get the time duration in month of this time window between min date and max date
         * 
    ...
    /**
     * The <code>TimeX</code> class defines a {@link Linear} window projection with timing bounds definition
     * on x dimension
     */
    public static class TimeX extends Time implements Serializable {

        /**
         * create a {@link Linear} window with typed time definition on x dimension
         * 
         * @param minXDate
         * @param maxXDate
         * @param miny
    ...
    /**
     * The <code>TimeY</code> class defines a {@link Linear} window projection with timing bounds definition
     * on y dimension
     */
    public static class TimeY extends Time implements Serializable {
        ...
        /**
         * bound this {@link TimeY} window with given times min and max date for y dimension
         * 
         * @param minx
         * @param maxx
         * @param minYDate
     ...
     * the information necessary to satisfy the various projection
     * methods below.
     */
    protected Window2D() {
    ...
    private void fireWindow2DPassivate() {
        ...
        synchronized (listeners) {
            for (int i = 0; i < listeners.length; i += 2) {
                if (listeners[i] == Window2DListener.class) {
                    ((Window2DListener) listeners[i + 1])
                            .window2DUnlockActive(w2dEvent);
                }
            }
        }
    }
    ...
    /**
     * Returns the user minimum X coordinate of this <code>Window2D</code> in <code>double</code> precision.
     * 
    ...
    /**
     * Returns the user minimum Y coordinate of this <code>Window2D</code> in <code>double</code> precision.
     * 
    ...
    /**
     * Returns the user maximum X coordinate of this <code>Window2D</code> in <code>double</code> precision.
     * 
    ...
    /**
     * Returns the user maximum Y coordinate of this <code>Window2D</code> in <code>double</code> precision.
     * 
    ...
    /**
     * Returns the pixel coordinate of this user <code>Point2D</code> in <code>double</code> precision.
     * 
    ...
    /**
     * Returns the user coordinate of this pixel <code>Point2D</code> in <code>double</code> precision.
     * 
     * @param pixelPoint
    ...
    /**
     * Returns the pixel x coordinate of this x user in <code>double</code> precision.
     * 
    ...
    /**
     * Returns the pixel y coordinate of this y user in <code>double</code> precision.
     * 
