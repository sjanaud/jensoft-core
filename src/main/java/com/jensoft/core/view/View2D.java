...
public class View2D extends JComponent implements Window2DListener,
     ...
     */
    public View2D(int placeHolderAxisWest, int placeHolderAxisEast,
            int placeHolderAxisSouth, int placeHolderAxisNorth) {
        super();
    ...
    public void repaintDevice(Rectangle rect) {
        device2D.repaint((int) (rect.getX() - 2), (int) (rect.getY() - 2),
                         (int) (rect.getWidth() + 4), (int) (rect.getHeight() + 4));
    }
     ...
     */
    public void setPartBackground(Color partBackground,
            WindowPart... windowParts) {
    ...
    public void setBackground(Color bg) {
        setPartBackground(bg, WindowPart.Device, WindowPart.East,
                          WindowPart.West, WindowPart.North, WindowPart.South);
    }
    ...
    /* (non-Javadoc)
     * @see com.jensoft.sw2d.core.window.Window2DListener#window2DBoundChanged(com.jensoft.sw2d.core.window.Window2DEvent)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jensoft.sw2d.core.window.Window2DListener#window2DLockActive(com.jensoft.sw2d.core.window.Window2DEvent)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jensoft.sw2d.core.window.Window2DListener#window2DUnlockActive(com.jensoft.sw2d.core.window.Window2DEvent)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jensoft.sw2d.core.window.Window2DListener#window2DResized(com.jensoft.sw2d.core.window.Window2DEvent)
     */
    @Override
    public void window2DResized(Window2DEvent w2dEvent) {}

    /**
     * set the place holder for the specified window part except device.
     * the place holder is the weight in pixel for the specified part, {@link WindowPart#East}, {@link WindowPart#West},
    ...
    /**
     * set the place holder for all border parts.
     * the place holder is the weight in pixel for the specified part, {@link WindowPart#East}, {@link WindowPart#West},
     * {@link WindowPart#North} and {@link WindowPart#South}.
     * 
     * @param placeHolder
    ...
    public BufferedImage getImageView(int width, int height) {
        ...
        if (width < 0 || height < 0) {
            throw new IllegalArgumentException(
                                               "view width and view height should be greater than zero");
        }

        // image view
        BufferedImage viewImage = new BufferedImage(width, height,
        ...
        eastPart.setSize(getPlaceHolderAxisEast(), getHeight()
                - getPlaceHolderAxisNorth() - getPlaceHolderAxisSouth());
        westPart.setSize(getPlaceHolderAxisWest(), getHeight()
                - getPlaceHolderAxisNorth() - getPlaceHolderAxisSouth());
        devicePart.setSize(getWidth() - getPlaceHolderAxisWest()
                - getPlaceHolderAxisEast(), getHeight()
                - getPlaceHolderAxisNorth() - getPlaceHolderAxisSouth());
        ...
        if (getPlaceHolderAxisNorth() > 0) {
            northImage = new BufferedImage(getWidth(),
                                           getPlaceHolderAxisNorth(), BufferedImage.TYPE_INT_ARGB);
        ...
        if (getPlaceHolderAxisSouth() > 0) {
            southImage = new BufferedImage(getWidth(),
                                           getPlaceHolderAxisSouth(), BufferedImage.TYPE_INT_ARGB);
        ...
        if (getPlaceHolderAxisEast() > 0) {
            eastImage = new BufferedImage(getPlaceHolderAxisEast(), getHeight()
                    - getPlaceHolderAxisNorth() - getPlaceHolderAxisSouth(),
                                          BufferedImage.TYPE_INT_ARGB);
        ...
        if (getPlaceHolderAxisWest() > 0) {
            westImage = new BufferedImage(getPlaceHolderAxisWest(), getHeight()
                    - getPlaceHolderAxisNorth() - getPlaceHolderAxisSouth(),
                                          BufferedImage.TYPE_INT_ARGB);
        ...
        if (getWidth() - getPlaceHolderAxisWest() - getPlaceHolderAxisEast() > 0
                && getHeight() - getPlaceHolderAxisNorth()
                        - getPlaceHolderAxisSouth() > 0) {
            deviceImage = new BufferedImage(getWidth()
                    - getPlaceHolderAxisWest() - getPlaceHolderAxisEast(),
                                            getHeight() - getPlaceHolderAxisNorth()
                                                    - getPlaceHolderAxisSouth(),
                                            BufferedImage.TYPE_INT_ARGB);
        ...
        if (northImage != null) {
            g2d.drawImage(northImage, 0, 0, northImage.getWidth(),
                          northImage.getHeight(), null);
        }

        if (southImage != null) {
            g2d.drawImage(southImage, 0, getHeight()
                    - getPlaceHolderAxisSouth(), southImage.getWidth(),
                          southImage.getHeight(), null);
            southImage.flush();
        }

        if (eastImage != null) {
            g2d.drawImage(eastImage, getWidth() - getPlaceHolderAxisEast(),
                          getPlaceHolderAxisNorth(), eastImage.getWidth(),
                          eastImage.getHeight(), null);
            eastImage.flush();
        }

        if (westImage != null) {
            g2d.drawImage(westImage, 0, getPlaceHolderAxisNorth(),
                          westImage.getWidth(), westImage.getHeight(), null);
            westImage.flush();
        }

        if (deviceImage != null) {
            g2d.drawImage(deviceImage, getPlaceHolderAxisWest(),
                          getPlaceHolderAxisNorth(), deviceImage.getWidth(),
                          deviceImage.getHeight(), null);
            deviceImage.flush();
        }
