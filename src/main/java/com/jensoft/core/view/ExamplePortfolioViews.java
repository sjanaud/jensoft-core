...
public class ExamplePortfolioViews {
	...
	public static void main(String[] args) {
		String outputDir = System.getProperty("user.home") + File.separator + ".jensoft" + File.separator + "portfolio" + File.separator + "example-portfolio";
	...
	public static View2D getPieBorderLabelView() {
		...
		PieSlice s2 = PieToolkit.createSlice("gray", ColorPalette.alpha(TangoPalette.BUTTER2, 255), 5, 0);
		PieSlice s3 = PieToolkit.createSlice("chameleon", ColorPalette.alpha(TangoPalette.CHAMELEON2, 255), 30, 0);
		PieSlice s4 = PieToolkit.createSlice("blue", ColorPalette.alpha(TangoPalette.SKYBLUE2, 255), 20, 0);
	...
	public static View2D getPie3DLabelBorderView1() {
		...
		// DONUT
		// create donut
		Donut3D donut3d = Donut3DToolkit.createDonut3D("myDonut", 16, 40, 30, 80, 60);
		...
		Donut3DSlice s4 = Donut3DToolkit.createDonut3DSlice("s4", Spectral.SPECTRAL_PURPLE1, 20);
		...
		// LABEL 1
		Donut3DBorderLabel label1 = Donut3DToolkit.createBorderLabel("Symbian", ColorPalette.WHITE, f, 20, 30);
		...
		// LABEL 2
		Donut3DBorderLabel label2 = Donut3DToolkit.createBorderLabel("WiMo", ColorPalette.WHITE, f, 20, 30);
		...
		// LABEL 3
		Donut3DBorderLabel label3 = Donut3DToolkit.createBorderLabel("android", ColorPalette.WHITE, f, 20, 30);
		...
		Donut3DBorderLabel label4 = Donut3DToolkit.createBorderLabel("iPhone", ColorPalette.WHITE, f, 20, 30);
	...
	public static View2D getVerticalBal() {
		...
		BarSymbolRelativeLabel b2g1Label = new BarSymbolRelativeLabel(VerticalAlignment.NorthBottom, HorizontalAlignment.WestLeft);
		...
		BarSymbolRelativeLabel b2g2Label = new BarSymbolRelativeLabel(VerticalAlignment.NorthBottom, HorizontalAlignment.EastRight);
	...
	public static View2D getScatterCurve() {
		...
		legend.setConstraints(new LegendConstraints(LegendPosition.East, 0.4f, LegendAlignment.Rigth));
	...
	public static View2D getRay1() {
		...
		legend.setLegendFill(new LegendGradientFill(Color.WHITE, Spectral.SPECTRAL_YELLOW.brighter()));
	...
	public static View2D getBubbleView1() {
		...
		legend.setLegendFill(new LegendGradientFill(Color.WHITE, Spectral.SPECTRAL_BLUE1.brighter()));
		legend.setFont(InputFonts.getFont(InputFonts.NEUROPOL, 12));
		legend.setConstraints(new LegendConstraints(LegendPosition.East, 0.4f, LegendAlignment.Rigth));
		LegendPlugin lgendL = new LegendPlugin();
		lgendL.addLegend(legend);
	...
	public static View2D getToolView() {
		...
		Legend l1 = LegendToolkit.createLegend("Objectif Bars Widget", InputFonts.getNeuropol(14), RosePalette.LIME, RosePalette.MANDARIN);
	...
	public static View2D getBandView() {
		...
		legend.setFont(InputFonts.getFont(InputFonts.ELEMENT, 14));
		legend.setLegendFill(new LegendGradientFill(Color.WHITE, window2D.getThemeColor()));
		legend.setConstraints(new LegendConstraints(LegendPosition.South, 0.8f, LegendAlignment.Rigth));
