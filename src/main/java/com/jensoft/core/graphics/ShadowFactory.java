...
/**
 * <p>
 * A shadow factory generates a drop shadow for any given picture, respecting the transparency channel if present. The
 * resulting picture contains the shadow only and to create a drop shadow effect you will need to stack the original
 * picture and the shadow generated by the factory. If you are using Swing you can get this done very easily with the
 * layout {@link org.jdesktop.swingx.StackLayout}.
 * </p>
 * <h2>Shadow Properties</h2>
 * <p>
 * A shadow is defined by three properties:
 * <ul>
 * <li><i>size</i>: The size, in pixels, of the shadow. This property also defines the fuzzyness.</li>
 * <li><i>opacity</i>: The opacity, between 0.0 and 1.0, of the shadow.</li>
 * <li><i>color</i>: The color of the shadow. Shadows are not meant to be black only.</li>
 * </ul>
 * You can set these properties using the provided mutaters or the appropriate constructor. Here are two ways of
 * creating a green shadow of size 10 and with an opacity of 50%:
 * 
 * <pre>
 ...
 * <p>
 * The factory provides two shadow generation algorithms: <i>fast quality blur</i> and <i>high quality blur</i>. You can
 * select your preferred algorithm by setting the appropriate rendering hint:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * The default rendering algorihtm is <code>VALUE_BLUR_QUALITY_FAST</code>.
 * </p>
 * <p>
 * The current implementation should provide the same quality with both algorithms but performances are guaranteed to be
 * better (about 30 times faster) with the <i>fast quality blur</i>.
 * </p>
 * <h2>Generating a Shadow</h2>
 * <p>
 * A shadow is generated as a <code>BufferedImage</code> from another <code>BufferedImage</code>. Once the factory is
 * set up, you must call {@link #createShadow} to actually generate the shadow:
 * 
 * <pre>
 * 
 * 
 ...
 * <p>
 * This factory allows to register property change listeners with {@link #addPropertyChangeListener}. Listening to
 * properties changes is very useful when you emebed the factory in a graphical component and give the API user the
 * ability to access the factory. By listening to properties changes, you can easily repaint the component when needed.
 * </p>
...
public class ShadowFactory {
    ...
    /**
     * <p>
     * Selects the fast rendering algorithm. This is the default rendering hint for <code>KEY_BLUR_QUALITY</code>.
     * </p>
     */
     ...
     * </p>
     * <p>
     * When the property change event is fired, the old value and the new value are provided as <code>Integer</code>
     * instances.
     * </p>
     */
     ...
     * </p>
     * <p>
     * When the property change event is fired, the old value and the new value are provided as <code>Float</code>
     * instances.
     * </p>
     */
     ...
     * </p>
     * <p>
     * Besides these properties you can set rendering hints to control the rendering process. The default rendering
     * hints let the factory use the fastest shadow generation algorithm.
     * </p>
     * 
     * @param size
     *            The size of the shadow in pixels. Defines the fuzziness.
     * @param opacity
    ...
    /**
     * <p>
     * Maps the specified rendering hint <code>key</code> to the specified <code>value</code> in this
     * <code>SahdowFactory</code> object.
     * </p>
     * 
     * @param key
    ...
    public void setColor(final Color shadowColor) {
        if (shadowColor != null) {
            ...
            color = shadowColor;
            changeSupport.firePropertyChange(COLOR_CHANGED_PROPERTY, oldColor,
                                             color);
        }
    }
    ...
    public void setOpacity(final float shadowOpacity) {
        ...
        changeSupport.firePropertyChange(OPACITY_CHANGED_PROPERTY, new Float(
                                                                             oldOpacity), new Float(opacity));
    }
     ...
     * </p>
     * <p>
     * There is virtually no limit to the size but it has an impact on shadow generation performances. The greater this
     * value, the longer it will take to generate the shadow. Remember the generated shadow image dimensions are
     * computed as follow:
     * <ul>
     * <li>new width = original width + 2 * shadow size</li>
     * <li>new height = original height + 2 * shadow size</li>
    ...
    public void setSize(final int shadowSize) {
        ...
        changeSupport.firePropertyChange(SIZE_CHANGED_PROPERTY, new Integer(
                                                                            oldSize), new Integer(size));
    }
     ...
     * </p>
     * <p>
     * The time taken by a call to this method depends on the size of the shadow, the larger the longer it takes, and on
     * the selected rendering algorithm.
     * </p>
     * 
     * @param image
    ...
    private BufferedImage createShadowFast(final BufferedImage src) {
        ...
        for (int srcY = 0, dstOffset = left * dstWidth; srcY < srcHeight; srcY++) {
            ...
            for (int srcX = 0; srcX < srcWidth; srcX++) {
                ...
                a = srcColorModel.getAlpha(srcRaster.getDataElements(srcX,
                                                                     srcY, null));
