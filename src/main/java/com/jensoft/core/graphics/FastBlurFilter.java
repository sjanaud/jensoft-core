...
/**
 * <p>
 * A fast blur filter can be used to blur pictures quickly. This filter is an implementation of the box blur algorithm.
 * The blurs generated by this algorithm might show square artifacts, especially on pictures containing straight lines
 * (rectangles, text, etc.) On most pictures though, the result will look very good.
 * </p>
 * <p>
...
public class FastBlurFilter extends AbstractFilter {
    ...
    /**
     * <p>
     * Blurs the source pixels into the destination pixels. The force of the blur is specified by the radius which must
     * be greater than 0.
     * </p>
     * <p>
