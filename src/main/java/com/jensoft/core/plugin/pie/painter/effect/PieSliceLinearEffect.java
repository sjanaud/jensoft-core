...
public class PieSliceLinearEffect extends AbstractPieSliceEffect {
     ...
     *            the offset radius
     */
    public PieSliceLinearEffect(Color startColor, Color endColor, int offsetRadius) {
    ...
    public PieSliceLinearEffect(Color startColor, Color endColor,
     ...
     */
    @Override
    protected void paintPieSliceEffect(Graphics2D g2d, Pie pie,
            PieSlice pieSection) {
        ...
        Ellipse2D e2 = new Ellipse2D.Double(centerX - innerRadius, centerY
