...
/**
 * <code>DeviceMetricsPlugin</code> takes the responsibility to manage metrics on {@link Device2D}
 * 
...
public abstract class DeviceMetricsPlugin<M extends AbstractMetricsManager> extends AbstractPlugin {
    ...
    /**
     * <code>DeviceStaticMetrics</code> takes the responsibility to manage static metrics on device
     * 
     * @author Sebastien Janaud
     */
    public static class DeviceStaticMetrics extends DeviceMetricsPlugin<StaticMetricsManager> {
        ...
        /**
         * <code>X</code> manages {@link DeviceStaticMetrics} for {@link DeviceAxis#AxisX}
         */
        public static class X extends DeviceStaticMetrics {

            /**
             * Create {@link DeviceStaticMetrics} for {@link DeviceAxis#AxisX} for given parameters
             * 
             * @param metricsCount
             * @param baseLine
             */
        ...
        /**
         * <code>Y</code> manages {@link DeviceStaticMetrics} for {@link DeviceAxis#AxisY}
         */
        public static class Y extends DeviceStaticMetrics {

            /**
             * Create {@link DeviceStaticMetrics} for {@link DeviceAxis#AxisY} for given parameters
             * 
             * @param metricsCount
             * @param baseLine
             */
         ...
         * @param deviceAxis
         */
        public DeviceStaticMetrics(int metricsCount, double baseLine, MarkerPosition markerPosition,
    ...
    /**
     * <code>DeviceFreeMetrics</code> takes the responsibility to manage free metrics on device
     * 
     * @author Sebastien Janaud
     */
    public static class DeviceFreeMetrics extends DeviceMetricsPlugin<FreeMetricsManager> {
        ...
        /**
         * <code>X</code> manages {@link DeviceFreeMetrics} for {@link DeviceAxis#AxisX}
         */
        public static class X extends DeviceFreeMetrics {

            /**
             * Create {@link DeviceFreeMetrics} for {@link DeviceAxis#AxisX} for given parameter
             * 
             * @param baseLine
             */
            ...
            /**
             * Create {@link DeviceFreeMetrics} for {@link DeviceAxis#AxisX} for given parameters
             * 
             * @param baseLine
             * @param markerPosition
             */
        ...
        /**
         * <code>Y</code> manages {@link DeviceFreeMetrics} for {@link DeviceAxis#AxisX}
         */
        public static class Y extends DeviceFreeMetrics {

            /**
             * Create {@link DeviceFreeMetrics} for {@link DeviceAxis#AxisY} for given parameter
             * 
             * @param baseLine
             */
            ...
            /**
             * Create {@link DeviceFreeMetrics} for {@link DeviceAxis#AxisY} for given parameters
             * 
             * @param baseLine
             * @param markerPosition
             */
    ...
    /**
     * <code>DeviceFlowMetrics</code> takes the responsibility to manage flow metrics on device
     * 
     * @author Sebastien Janaud
     */
    public static class DeviceFlowMetrics extends DeviceMetricsPlugin<FlowMetricsManager> {
        ...
        /**
         * <code>X</code> manages {@link DeviceFlowMetrics} for {@link DeviceAxis#AxisX}
         */
        public static class X extends DeviceFlowMetrics {

            /**
             * Create {@link DeviceFlowMetrics} for {@link DeviceAxis#AxisX} with the given flow parameters at the
             * specified base line
             * 
             * @param flowStart
             * @param flowEnd
        ...
        /**
         * <code>Y</code> manages {@link DeviceFlowMetrics} for {@link DeviceAxis#AxisY}
         */
        public static class Y extends DeviceFlowMetrics {

            /**
             * Create {@link DeviceFlowMetrics} for {@link DeviceAxis#AxisY} with the given flow parameters at the
             * specified base line
             * 
             * @param flowStart
             * @param flowEnd
            ...
            /**
             * Create {@link DeviceFlowMetrics} for {@link DeviceAxis#AxisY} with the given flow parameters at the
             * specified base line and marker position
             * 
             * @param flowStart
             * @param flowEnd
             * @param flowInterval
        ...
        /**
         * Create a new instance of a <code>DeviceFlowMetrics<code> with the specified reference.
         * 
         * @param flowStart
         ...
         */
        public DeviceFlowMetrics(double flowStart, double flowEnd, double flowInterval, double baseLine,
                DeviceAxis deviceAxis) {
    ...
    /**
     * <code>DeviceMultiplierMetrics</code> takes the responsibility to manage device metrics with one multiplier
     * <p style="color : red;">
    ...
    public static class DeviceMultiplierMetrics extends DeviceMetricsPlugin<MultiplierMetricsManager> {
        ...
        /**
         * <code>X</code> manages {@link DeviceMultiplierMetrics} for {@link DeviceAxis#AxisX}
         */
        public static class X extends DeviceMultiplierMetrics {

            /**
             * Create {@link DeviceMultiplierMetrics} for {@link DeviceAxis#AxisX} for given parameters
             * 
             * @param metricsRef
        ...
        /**
         * <code>Y</code> manages {@link DeviceMultiplierMetrics} for {@link DeviceAxis#AxisY}
         */
        public static class Y extends DeviceMultiplierMetrics {

            /**
             * Create {@link DeviceMultiplierMetrics} for {@link DeviceAxis#AxisY} for given parameters
             * 
             * @param metricsRef
             * @param metricsInterval
             * @param baseLine
         ...
         *            the device axis zone to lay out this metrics
         */
        public DeviceMultiplierMetrics(double metricsRef, double metricsInterval, double baseLine,
                MarkerPosition markerPosition, DeviceAxis deviceAxis) {
    ...
    /**
     * <code>DeviceMultiMultiplierMetrics</code> takes the responsibility to manage 3-multipliers metrics on device
     * <p style="color : red;">
     * WARNING : can be reboot on to much iteration.
     * </p>
     * <p>
    ...
    /**
     * <code>DeviceTimeMetrics</code> takes the responsibility to manage timing metrics on device
     * 
     * @author sebastien janaud
     */
    public static class DeviceTimeMetrics extends DeviceMetricsPlugin<TimeMetricsManager> {
        ...
        /**
         * <code>X</code> manages {@link DeviceTimeMetrics} for {@link DeviceAxis#AxisX}
         */
        ...
        /**
         * <code>Y</code> manages {@link DeviceTimeMetrics} for {@link DeviceAxis#AxisY}
         */
    ...
    /**
     * <code>DeviceModeledMetrics</code> takes the responsibility to manage modeled metrics on device
     * 
     * @author sebastien janaud
     */
    public static class DeviceModeledMetrics extends DeviceMetricsPlugin<ModeledMetricsManager> {
        ...
        /**
         * <code>X</code> manages {@link DeviceModeledMetrics} for {@link DeviceAxis#AxisX}
         */
        ...
        /**
         * <code>Y</code> manages {@link DeviceModeledMetrics} for {@link DeviceAxis.AxisY}
         */
     ...
     */
    public DeviceMetricsPlugin(M manager, double baseLine,
            DeviceAxis deviceAxis) {
     ...
     */
    public DeviceMetricsPlugin(M manager, double baseLine,
            MarkerPosition deviceMarkerPosition, DeviceAxis deviceAxis) {
        metricsManager = manager;
        this.baseLine = baseLine;
        this.deviceAxis = deviceAxis;
     ...
     *            the manager to set
     */
    public void setMetricsManager(
            M metricsLayoutManager) {
    ...
    protected void paintMetricsX(View2D v2d, Graphics2D g2d, List<Metrics> metricsX, double baseLine, int offsetPixel) {
        ...
        for (Metrics m : metricsX) {
            ...
            // p = new Point2D.Double(m.getDeviceValue(), deviceBaseLine.getY());
    ...
    protected void paintMetricsXBaseLine(View2D v2d, Graphics2D g2d, double baseLine) {
        ...
        metricsPainter.doPaintLineMetrics(g2d, new Point2D.Double(0, deviceBaseLine.getY()),
                                          new Point2D.Double(getWindow2D().getDevice2D().getDeviceWidth(),
                                                             deviceBaseLine.getY()),
                                          axisBaseLineColor);
    ...
    protected void paintMetricsYBaseLine(View2D v2d, Graphics2D g2d, double baseLine) {
        ...
        metricsPainter.doPaintLineMetrics(g2d,
                                          new Point2D.Double(deviceBaseLine.getX(), 0),
                                          new Point2D.Double(deviceBaseLine.getX(), getWindow2D().getDevice2D()
                                                  .getDeviceHeight()),
                                          axisBaseLineColor);
