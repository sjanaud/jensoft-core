...
/**
 * <code>AxisMetricsPlugin</code> takes the responsibility to draw metrics for {@link Axis}
 * 
...
public abstract class AxisMetricsPlugin<M extends AbstractMetricsManager> extends AbstractPlugin {
    ...
    /**
     * <code>StaticMetrics</code> takes the responsibility to manage static metrics
     * 
     * @author sebastien janaud
     */
    public static class StaticMetrics extends AxisMetricsPlugin<StaticMetricsManager> {
        ...
        /**
         * <code>W</code> manages {@link StaticMetrics} for {@link Axis#AxisWest}
         */
        ...
        /**
         * <code>E</code> manages {@link StaticMetrics} for {@link Axis#AxisEast}
         */
        ...
        /**
         * <code>N</code> manages {@link StaticMetrics} for {@link Axis#AxisNorth}
         */
        ...
        /**
         * <code>S</code> manages {@link StaticMetrics} for {@link Axis#AxisSouth}
         */
        ...
        /**
         * Create {@link StaticMetrics} with the given metrics count and specified {@link Axis}
         * 
         * @param metricsCount
         * @param axis
         */
    ...
    public static class FlowMetrics extends AxisMetricsPlugin<FlowMetricsManager> {
        ...
        public static class W extends FlowMetrics {
            ...
            /**
             * Create {@link FlowMetrics} for {@link Axis#AxisWest} with the given flow parameters
             * 
             * @param flowStart
             * @param flowEnd
             * @param flowInterval
             */
            public W(double flowStart, double flowEnd,
                    double flowInterval) {
        ...
        public static class E extends FlowMetrics {
            ...
            /**
             * Create {@link FlowMetrics} for {@link Axis#AxisEast} with the given flow parameters
             * 
             * @param flowStart
             * @param flowEnd
             * @param flowInterval
             */
            public E(double flowStart, double flowEnd,
                    double flowInterval) {
        ...
        public static class N extends FlowMetrics {
            ...
            /**
             * Create {@link FlowMetrics} for {@link Axis#AxisNorth} with the given flow parameters
             * 
             * @param flowStart
             * @param flowEnd
             * @param flowInterval
             */
            public N(double flowStart, double flowEnd,
                    double flowInterval) {
        ...
        public static class S extends FlowMetrics {
            ...
            /**
             * Create {@link FlowMetrics} for {@link Axis#AxisSouth} with the given flow parameters
             * 
             * @param flowStart
             * @param flowEnd
             * @param flowInterval
             */
            public S(double flowStart, double flowEnd,
                    double flowInterval) {
         ...
         *            the metrics axis
         */
        public FlowMetrics(double flowStart, double flowEnd,
                double flowInterval, Axis axis) {
    ...
    /**
     * <code>MultiplierMetrics</code> takes the responsibility to manage metrics with 1 multiplier
     * <p style="color : red;">
    ...
    public static class MultiplierMetrics extends AxisMetricsPlugin<MultiplierMetricsManager> {
        ...
        /**
         * <code>W</code> manages {@link MultiplierMetrics} for {@link Axis#AxisWest}
         */
        public static class W extends MultiplierMetrics {

            /**
             * Create {@link MultiplierMetrics} for {@link Axis#AxisWest} with the given multiplier parameter
             * 
             * @param ref
             * @param multiplier
             */
        ...
        /**
         * <code>W</code> manages {@link MultiplierMetrics} for {@link Axis#AxisEast}
         */
        public static class E extends MultiplierMetrics {

            /**
             * Create {@link MultiplierMetrics} for {@link Axis#AxisEast} with the given multiplier parameter
             * 
             * @param ref
             */
        ...
        /**
         * <code>W</code> manages {@link MultiplierMetrics} for {@link Axis#AxisNorth}
         */
        public static class N extends MultiplierMetrics {

            /**
             * Create {@link MultiplierMetrics} for {@link Axis#AxisNorth} with the given multiplier parameter
             * 
             * @param ref
             */
        ...
        /**
         * <code>W</code> manages {@link MultiplierMetrics} for {@link Axis#AxisSouth}
         */
        public static class S extends MultiplierMetrics {

            /**
             * Create {@link MultiplierMetrics} for {@link Axis#AxisSouth} with the given multiplier parameter
             * 
             * @param ref
             */
         ...
         * @param multiplier
         *            the metrics interval to factor from the reference into window
         *            bound metrics
         * @param axis
    ...
    /**
     * <code>MultiMultiplierMetrics</code> takes the responsibility to manage metrics with 3 multipliers
     * <p style="color : red;">
     * WARNING : can be reboot on to much iteration.
     * </p>
     * <p>
    ...
    public static class MultiMultiplierMetrics extends AxisMetricsPlugin<MultiMultiplierMetricsManager> {
        ...
        /**
         * <code>W</code> manages {@link MultiMultiplierMetrics} for {@link Axis#AxisWest}
         */
        public static class W extends MultiMultiplierMetrics {

            /**
             * Create {@link MultiMultiplierMetrics} for {@link Axis#AxisWest} with the given multiplier parameter
             * 
             * @param ref
             */
            public W(double ref) {
        ...
        /**
         * <code>E</code> manages {@link MultiMultiplierMetrics} for {@link Axis#AxisEast}
         */
        public static class E extends MultiMultiplierMetrics {

            /**
             * Create {@link MultiMultiplierMetrics} for {@link Axis#AxisEast} with the given multiplier parameter
             * 
             * @param ref
             */
            public E(double ref) {
        ...
        /**
         * <code>N</code> manages {@link MultiMultiplierMetrics} for {@link Axis#AxisNorth}
         */
        public static class N extends MultiMultiplierMetrics {

            /**
             * Create {@link MultiMultiplierMetrics} for {@link Axis#AxisNorth} with the given multiplier parameter
             * 
             * @param ref
             */
            public N(double ref) {
        ...
        /**
         * <code>S</code> manages {@link MultiMultiplierMetrics} for {@link Axis#AxisSouth}
         */
        public static class S extends MultiMultiplierMetrics {

            /**
             * Create {@link MultiMultiplierMetrics} for {@link Axis#AxisSouth} with the given multiplier parameter
             * 
             * @param ref
             */
            public S(double ref) {
    ...
    /**
     * <code>TimeMetrics</code> takes the responsibility to manage timing metrics on axis
     * 
     * @author sebastien janaud
     */
    public static class TimeMetrics extends AxisMetricsPlugin<TimeMetricsManager> {
        ...
        /* (non-Javadoc)
         * @see com.jensoft.sw2d.core.plugin.metrics.AxisMetricsPlugin#paintMetrics(com.jensoft.sw2d.core.view.View2D, java.awt.Graphics2D, com.jensoft.sw2d.core.window.WindowPart)
         */
        @Override
            ...
            for (TimeModel timingManager : sequence) {
                ...
                for (int i = 0; i < metrics.size(); i++) {
                    ...
                    if (windowPart == WindowPart.South) {
                        markerLocation = new Point2D.Double(v2d.getPlaceHolderAxisWest() + m.getDeviceValue(),
                                                            axisSpacing);
                    ...
                    if (windowPart == WindowPart.North) {
                        ...
                        markerLocation = new Point2D.Double(v2d.getPlaceHolderAxisWest() + m.getDeviceValue(),
                                                            component.getHeight() - 1 - axisSpacing);
                        m.setMarkerLocation(markerLocation);
    ...
    /**
     * <code>ModeledMetrics</code> takes the responsibility to manage metrics from models
     * 
     * @author sebastien janaud
     */
    public static class ModeledMetrics extends AxisMetricsPlugin<ModeledMetricsManager> {
        ...
        /**
         * <code>W</code> manages {@link ModeledMetrics} for {@link Axis#AxisWest}
         */
        ...
        /**
         * <code>E</code> manages {@link ModeledMetrics} for {@link Axis#AxisEast}
         */
        ...
        /**
         * <code>N</code> manages {@link ModeledMetrics} for {@link Axis#AxisNorth}
         */
        ...
        /**
         * <code>S</code> manages {@link ModeledMetrics} for {@link Axis#AxisSouth}
         */
        ...
        /*
         * (non-Javadoc)
         * @see com.jensoft.sw2d.core.plugin.metrics.AxisMetricsPlugin#doPaintMetrics(com.jensoft.sw2d.core.view.View2D,
        ...
        protected void paintMetrics(View2D v2d, Graphics2D g2d, WindowPart windowPart) {
            ...
            for (MetricsModel model : sequence) {
                ...
                // System.out.println("paints " +getMetricsManager().getType().name()+" "+ metrics.size() +
     ...
     */
    public enum Axis {
        AxisSouth("AxisSouth"), AxisNorth("AxisNorth"), AxisWest("AxisWest"), AxisEast(
                "AxisEast");
    ...
    /**
     * Create a new <code>AxisMetricsPlugin<code> with the specified manager and axis
     * 
     * @param manager
     *            the manager
     * @param axis
    ...
    protected void paintBaseLine(View2D v2d, Graphics2D g2d, WindowPart windowPart) {
        if (isPaintAxisBaseLine()) {
            ...
            if (windowPart == WindowPart.South) {
                ...
                axisStartLocation = new Point2D.Double(
                                                       v2d.getPlaceHolderAxisWest(), axisSpacing);
                axisEndLocation = new Point2D.Double(component.getWidth()
                        - v2d.getPlaceHolderAxisEast(), axisSpacing);
            }
            if (windowPart == WindowPart.West) {
                JComponent component = v2d.getWindowComponent(WindowPart.West);
                axisStartLocation = new Point2D.Double(component.getWidth() - 1
                        - axisSpacing, 0);
                axisEndLocation = new Point2D.Double(component.getWidth() - 1
                        - axisSpacing, component.getHeight());
            }
            if (windowPart == WindowPart.East) {
                JComponent component = v2d.getWindowComponent(WindowPart.East);
                axisStartLocation = new Point2D.Double(axisSpacing, 0);
                axisEndLocation = new Point2D.Double(axisSpacing,
                                                     component.getHeight());
            }
            if (windowPart == WindowPart.North) {
                JComponent component = v2d.getWindowComponent(WindowPart.North);
                axisStartLocation = new Point2D.Double(
                                                       v2d.getPlaceHolderAxisWest(), component.getHeight() - 1
                                                               - axisSpacing);
                axisEndLocation = new Point2D.Double(component.getWidth()
                        - v2d.getPlaceHolderAxisEast(), component.getHeight()
                        - 1 - axisSpacing);
            }

            Color axisBaseLineColor;
            if (metricsManager.getMetricsBaseLineColor() != null) {
                axisBaseLineColor = metricsManager
                        .getMetricsBaseLineColor();
            }
            else {
                axisBaseLineColor = metricsManager.getRenderContext().getWindow2D().getThemeColor();
            }
            metricsPainter.doPaintLineMetrics(g2d, axisStartLocation,
                                              axisEndLocation, axisBaseLineColor);
        }
    }
    ...
    protected void paintMetricsLabelIndicator(View2D v2d, Graphics2D g2d, WindowPart windowPart) {
        ...
        for (int i = 0; i < metrics.size(); i++) {
            ...
            if (windowPart == WindowPart.West) {
                JComponent component = v2d.getWindowComponent(WindowPart.West);
                markerLocation = new Point2D.Double(component.getWidth() - 1
                        - axisSpacing, m.getDeviceValue());
                m.setMarkerLocation(markerLocation);
                m.setMarkerPosition(MarkerPosition.W);
            }
            if (windowPart == WindowPart.East) {
            ...
            if (windowPart == WindowPart.North) {
                JComponent component = v2d.getWindowComponent(WindowPart.North);
                markerLocation = new Point2D.Double(
                                                    v2d.getPlaceHolderAxisWest() + m.getDeviceValue(),
                                                    component.getHeight() - 1 - axisSpacing);
                m.setMarkerLocation(markerLocation);
                m.setMarkerPosition(MarkerPosition.N);
            }
