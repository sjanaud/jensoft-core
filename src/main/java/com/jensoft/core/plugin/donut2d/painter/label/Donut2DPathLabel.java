 ...
 * <p>
 * Donut2D Path label lay out donut3D slice labels on donut3D slice path fragments like external arc or<br>
...
public class Donut2DPathLabel extends AbstractDonut2DSliceLabel {
     ...
     */
    @Override
    protected void paintDonut2DSliceLabel(Graphics2D g2d, Donut2D donut3d,
            Donut2DSlice donutSlice) {
        TextPath pt = null;
