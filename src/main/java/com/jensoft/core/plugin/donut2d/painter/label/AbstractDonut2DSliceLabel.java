...
/**
 * <code>AbstractDonut2DSliceLabel</code>
 * <p>
 ...
 */
public abstract class AbstractDonut2DSliceLabel extends AbstractDonut2DSlicePainter {
     ...
     * @param slice
     *            the slice that brings labels to paint
     */
    protected abstract void paintDonut2DSliceLabel(Graphics2D g2d, Donut2D donut2d, Donut2DSlice slice);
    ...
    public final void paintDonut2DSlice(Graphics2D g2d, Donut2D donut2d, Donut2DSlice slice) {
        paintDonut2DSliceLabel(g2d, donut2d, slice);
    }
