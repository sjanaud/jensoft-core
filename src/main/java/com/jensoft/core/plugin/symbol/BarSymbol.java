...
public class BarSymbol extends SymbolComponent {
    ...
    public void setAscentValue(double value) {
        ...
        if (value < 0) {
            throw new IllegalArgumentException(
                                               "bar value should be greater than 0");
        }
        this.value = value;
    }
                ...
                for (int i = 0; i < step; i++) {
                    ...
                    if (getHost() != null) {
                        if (getLayer() == null) {
                            ...
                            ((BarSymbolLayer) getLayer())
                                    .solveSymbolComponent(BarSymbol.this);
                        }
                    }
                    if (getNature() == SymbolNature.Vertical) {
                        getHost()
                                ...
                                .repaintDeviceBand(
                                                   DeviceBand.XBand,
                                                   (int) getBarShape().getBounds().getX(),
                                                   (int) getBarShape().getBounds()
                                                           .getWidth() + 1);
                    }
                        ...
                        getHost()
                                ...
                                .repaintDeviceBand(
                                                   DeviceBand.YBand,
                                                   (int) getBarShape().getBounds().getY(),
                                                   (int) getBarShape().getBounds()
                                                           .getHeight() + 1);
                    }
    ...
    public void deflate(double deltaValue, int waitBeforeStarting, int delay,
        ...
        deflate = new Deflate(deltaValue, waitBeforeStarting, delay,
                              step);
        deflate.start();
    }
