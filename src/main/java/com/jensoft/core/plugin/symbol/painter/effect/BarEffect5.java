...
public class BarEffect5 extends AbstractBarEffect {
    ...
    private void paintEffectHBar_ef2(Graphics2D g2d, BarSymbol bar) {
        ...
        if (bar.getMorpheStyle() == MorpheStyle.Round) {
            ...
            if (bar.isAscent()) {
                barPath.moveTo(x, y);
                barPath.quadTo(x + width / 2, y + height / 3,
                               x + width - round, y);
                ...
                barPath.quadTo(x + width, y + height, x + width - round, y
                        + height);
                barPath.quadTo(x + width / 2, y + 2 * height / 3, x, y + height);
                barPath.closePath();
                ...
                barPath.quadTo(x + width / 2, y + height / 3, x + width, y);
                barPath.lineTo(x + width, y + height);
                barPath.quadTo(x + width / 2, y + 2 * height / 3, x + round, y
                        + height);
