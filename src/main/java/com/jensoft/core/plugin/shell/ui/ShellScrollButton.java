 ...
 */
package com.jensoft.core.plugin.shell.ui;
...
class ShellScrollButton extends MetalScrollButton {
    ...
    public ShellScrollButton(int direction, int width, boolean freeStanding) {
        super(direction, width, freeStanding);
        setOpaque(false);
    }

    public ShellScrollButton(int direction, int width, boolean freeStanding, Color scrollerButtonColor) {
        super(direction, width, freeStanding);
