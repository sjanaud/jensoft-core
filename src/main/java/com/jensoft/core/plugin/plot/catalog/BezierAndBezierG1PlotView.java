...
@JenSoftView
public class BezierAndBezierG1PlotView extends View2D {

	public BezierAndBezierG1PlotView() {
		super(80);
		...
		plot.setPlotDrawColor(NanoChromatique.ORANGE);
		plotsPlugin.addPlot(plot);
		anchorsPlugin.addPlot(plot);
	...
	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new BezierAndBezierG1PlotView());
	}
