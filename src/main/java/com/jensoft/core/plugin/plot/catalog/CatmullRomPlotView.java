...
@JenSoftView
public class CatmullRomPlotView extends View2D {

	public CatmullRomPlotView() {
		super(80);
		...
		//CATMULL ROM PLOT
		CatmullRom plot = new CatmullRom();
		plot.addPoint(-80, 30);
		plot.addPoint(-60, -20);
		plot.addPoint(-40, 70);
		plot.addPoint(-20, 20);
	...
	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new CatmullRomPlotView());
	}
