...
@JenSoftAPIDemo
public class GaugeTestDemo extends View2D {

	private static final long serialVersionUID = 156889765687899L;

	public GaugeTestDemo() {
		super();

		Window2D w2d = new Window2D.Linear.Identity();
		registerWindow2D(w2d);
		
		GaugeTest gauge = new GaugeTest();
	...
	public static void main(String[] args) throws Exception {
		final ViewFrameUI demoFrame = new ViewFrameUI(new GaugeTestDemo());
