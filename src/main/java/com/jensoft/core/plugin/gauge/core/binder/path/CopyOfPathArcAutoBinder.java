 ...
 * 
 */
public class CopyOfPathArcAutoBinder extends PathBinder {
	 ...
	 * 
	 */
	public CopyOfPathArcAutoBinder(int radius, int polarRadius, float polarDegree) {
		this.radius = radius;
	 ...
	 * @param direction
	 */
	public CopyOfPathArcAutoBinder(int radius, int polarRadius, float polarDegree, Direction direction) {
		super();
		this.radius = radius;
		this.polarRadius = polarRadius;
		this.polarDegree = polarDegree;
	...
	public void debug(Graphics2D g2d, RadialGauge gauge) {
		...
		g2d.drawString("PATH BINDER : "+CopyOfPathArcAutoBinder.class.getSimpleName(), 20, 60);
