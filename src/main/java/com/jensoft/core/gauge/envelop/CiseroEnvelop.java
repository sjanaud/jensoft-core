...
public class CiseroEnvelop extends EnvelopGaugePainter {
	...
	public void paint2(Graphics2D g2d) {
		...
		if (envelopPart == null) {
			...
			radiusInternal2 = getGauge().getRadius() + 10;
			Area area2 = new Area(new Ellipse2D.Double(centerX - radiusInternal2, centerY - radiusInternal2, 2 * radiusInternal2, 2 * radiusInternal2));
			// g2dPart.draw(area1);
			// g2dPart.draw(area2);
			...
			double x = centerX + (radiusInternal2 + 15) * Math.cos(Math.toRadians(30));
			double y = centerY - (radiusInternal2 + 15) * Math.sin(Math.toRadians(30));

			Split s = new Split(x, y, 10, 30);
			s.draw(g2dPart);
			// s.draw(g2d);

			x = centerX + (radiusInternal2 + 15) * Math.cos(Math.toRadians(90 + 60));
			y = centerY - (radiusInternal2 + 15) * Math.sin(Math.toRadians(90 + 60));
			s = new Split(x, y, 10, 90 + 60);
			s.draw(g2dPart);
			// s.draw(g2d);

			x = centerX + (radiusInternal2 + 15) * Math.cos(Math.toRadians(180 + 30));
			y = centerY - (radiusInternal2 + 15) * Math.sin(Math.toRadians(180 + 30));
			s = new Split(x, y, 10, 180 + 30);
			s.draw(g2dPart);
			// s.draw(g2d);

			x = centerX + (radiusInternal2 + 15) * Math.cos(Math.toRadians(270 + 60));
			y = centerY - (radiusInternal2 + 15) * Math.sin(Math.toRadians(270 + 60));
