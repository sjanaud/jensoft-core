...
public class StripeInflater extends AbstractX2DPluginInflater<StripePlugin> {
    ...
    public void inflate(Element pluginElement) {
        Element managersElement = (Element) pluginElement.getElementsByTagName(
                                                                               "managers").item(0);
        NodeList managerElements = managersElement
    ...
    public void inflateDynamicManager(Element managerElement) {
        ...
        Element paletteElement = (Element) managerElement
        ...
        if (bo != null && bandRef != null && bandInterval != null
                && palette != null) {
//            DynamicStripeManager manager = new DynamicStripeManager(bo, bandRef,
//                                                                    bandInterval);
...
//            getPlugin().addManager(manager);
    ...
    public void inflateFlowManager(Element managerElement) {
        ...
        if (bo != null && bandStart != null && bandEnd != null
                && bandInterval != null) {
            FlowStripeManager manager = new FlowStripeManager(bo, bandStart,
                                                              bandEnd, bandInterval);
    ...
    public void inflateFreeManager(Element managerElement) {
        ...
        Element bandsElement = (Element) managerElement
        ...
        for (int i = 0; i < bandElements.getLength(); i++) {
            ...
            Element colorElement = (Element) bandElement.getElementsByTagName(
                                                                              "color").item(0);
            ...
            if (freeBandManager != null && bandStart != null && bandEnd != null
                    && bandColor != null) {
                Stripe b = new Stripe();
