...
public class DashboardFrameUI extends JFrame {
	...
	private void create() {
		...
		tabSet.addComandTab(demoTab, demo);
		...
		loadSource(dashboardSourcePane, demo.getClass());
		...
		if (demo.getClass().isAnnotationPresent(JenSoftDashboard.class)) {
			JenSoftDashboard dashboardAnnotation = demo.getClass().getAnnotation(JenSoftDashboard.class);
