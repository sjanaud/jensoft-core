 ...
 */
package com.jensoft.core.demo.xml;
...
public class XmlView extends PlainView {
    ...
    // private static String TAG_PATTERN = "(</?[a-z]*-*[a-z]*-*[a-z]*)\\s?>?";
    private static String TAG_PATTERN = "(</?\\w*-*\\w*-*\\w*)\\s?>?";

    private static String TAG_END_PATTERN = "(/>)";
    private static String TAG_ATTRIBUTE_PATTERN = "\\s(\\w*)\\=";
    private static String TAG_XSIATTRIBUTE_PATTERN = "\\s(\\w*:\\w*)\\=";
